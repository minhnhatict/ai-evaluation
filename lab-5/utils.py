...
def get_openai_api_key():
    return "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"

def get_phoenix_endpoint():
    phoenix_endpoint = os.getenv("http://localhost:6006/")
